...
const About = () => {
  return (
    <div className='m-[30px] flex md:flex-row flex-col gap-[3rem] font-montserrat'>
     ...
     <div>
       <p className='text-[#F77A4A] text-[56px] font-[700]'>About Us</p>
       <p className='text-[#4D4D4D] text-[24px] pb-[20px]'>Welcome to TimeSync, your dedicated companion in navigating a more intelligent approach to time and task management. Our platform is crafted to offer you a seamless experience in time tracking, ensuring precision and efficiency.</p>
       <p className='text-[#4D4D4D] text-[24px] pb-[20px]'>Beyond that, TimeSync is your partner in effective project management, providing tools and features to enhance collaboration and productivity. Dive into insightful analytics to gain a comprehensive understanding of your workflow, empowering you to make informed decisions.</p>
       <p className='text-[#4D4D4D] text-[24px] pb-[20px]'>Join us on a journey where managing your time and tasks becomes not just a routine but a strategic and fulfilling endeavor.</p>
