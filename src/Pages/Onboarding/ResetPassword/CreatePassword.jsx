...
const CreatePassword = ({ psswrdDetails, handleSubmit, psswrdError, loading, error, handleChange }) => {
  return (
    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="flex flex-col mt-[72px] lg:-[35px] xl:mt-[45px] 2xl:mt-[52px] gap-y-[12px] font-[400]">
        <input
          ...
          className=
          {` ${
            error?.psswrd && "border border-red-400"
          } 
        ...
        {error && (
          <div className="flex flex-col px-[12px]">
            <div className="flex items-center gap-x-[8px]">
              ...
              <p className={`${psswrdError?.length ? 'text-[#D42620]' : 'text-[#0F973D]'}  text-[10px] leading-[23.6px] font-[400] `}>
            ...
            <div className="flex items-center gap-x-[8px]">
              ...
              <p className={`${psswrdError?.test ? 'text-[#D42620]' : 'text-[#0F973D]'}  text-[10px] leading-[23.6px] font-[400] `}>
            ...
            <div className="flex items-center gap-x-[8px]">
              ...
              <p className={`${psswrdError?.upperCase ? 'text-[#D42620]' : 'text-[#0F973D]'}  text-[10px] leading-[23.6px] font-[400] `}>
